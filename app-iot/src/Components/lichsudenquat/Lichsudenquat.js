...
import "./lichsudenquat.css"
function Lichsudenquat() {
    ...
    useEffect(() => {
        ...
        fetch(`http://localhost:8080/${searchClicked ? `searchfanlight?startTime=${thoigian} 00:00:00&endTime=${thoigian} 23:59:59` : `fanlights`}`) // Thay thế URL_API_CUA_BAN bằng URL API thực tế
